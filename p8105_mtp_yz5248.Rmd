...
```
The left panel shows the full distribution of FHP size, revealing right-skewed patterns and larger FHP in males and older participants—details hidden in the original summary statistics.
The right panel displays the rate (not count) of enlarged EOP (≥10 mm), showing higher prevalence in males and an increase with age.  
